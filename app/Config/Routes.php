...
$routes->get('sys_settings', 'Settings::index');
$routes->get('sys_settings/carousel', 'Settings::carousel');
$routes->post('sys_settings/update-carousel', 'Settings::updateCarousel');
...
$routes->group('bansos-rtlh', function($routes) {
    ...
    $routes->get('print/(:num)', 'BansosRtlh::print/$1');
