...
<div class="max-w-3xl mx-auto">
    <div class="mb-8">
        <h1 class="text-2xl font-black text-blue-950 uppercase tracking-wider">Tambah User</h1>
        <p class="text-slate-400 text-sm font-medium italic">Daftarkan akun petugas baru ke dalam sistem.</p>
    </div>

    <div class="bg-white rounded-[2rem] border border-slate-100 shadow-sm overflow-hidden">
        <form action="<?= base_url('users/store') ?>" method="post" class="p-8 space-y-6">
            <?= csrf_field() ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    <label class="block text-[10px] font-black text-blue-900 uppercase tracking-widest mb-2 ml-1">Password</label>
                ...
                <div>
                    ...
                    <select name="role_id" id="role_id" required class="w-full p-4 bg-slate-50 border border-slate-100 rounded-2xl outline-none">
            ...
            <div id="desa_select_wrapper">
                ...
                <p class="mt-2 text-[9px] text-slate-400 italic">Kosongkan jika admin pusat.</p>
            </div>
