...
<div class="max-w-7xl mx-auto space-y-6 pb-32 text-slate-900 dark:text-slate-200">
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 bg-white dark:bg-slate-900 p-6 rounded-[2rem] border border-slate-100 dark:border-slate-800 shadow-sm transition-all duration-300 relative overflow-hidden">
        ...
        <div class="relative z-10 flex items-center gap-5">
            ...
            <div>
                <h1 class="text-2xl md:text-3xl font-black text-blue-950 dark:text-white uppercase tracking-tighter">Tambah Pengguna</h1>
                <p class="text-xs text-slate-500 font-bold uppercase tracking-widest mt-1">Buat Kredensial Akses Petugas Baru</p>
            </div>
        </div>
        <div class="flex items-center gap-3 relative z-10">
            <a href="<?= base_url('users') ?>" class="px-5 py-2.5 bg-slate-100 dark:bg-slate-800 text-slate-500 dark:text-slate-400 rounded-xl text-[10px] font-black uppercase tracking-widest hover:bg-slate-200 dark:hover:bg-slate-700 transition-all active:scale-95">Batal</a>
        </div>
    </div>
            ...
            <div class="lg:col-span-2 space-y-6">
                <div class="bg-white dark:bg-slate-900 rounded-[2rem] border border-slate-100 dark:border-slate-800 shadow-sm overflow-hidden">
                    <div class="p-6 border-b dark:border-slate-800 bg-blue-50/30 dark:bg-blue-950/30 flex items-center gap-3">
                        ...
                        <div>
                            <h3 class="text-[11px] font-black text-blue-900 dark:text-blue-400 uppercase tracking-[0.2em]">Informasi Login</h3>
                            <p class="text-[9px] text-slate-400 font-bold uppercase tracking-widest">Kredensial Keamanan Akun</p>
                        </div>
                    </div>
                    <div class="p-8 space-y-6">
                        <div>
                            <label class="block text-[9px] font-black text-slate-400 dark:text-slate-500 uppercase mb-2 tracking-widest ml-1">Username Pengguna</label>
                            <input type="text" name="username" required class="w-full p-3.5 bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-xl focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 dark:text-slate-200 outline-none transition-all font-black uppercase placeholder:opacity-30" placeholder="EX: PETUGAS_SINJAI">
                        </div>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <label class="block text-[9px] font-black text-slate-400 dark:text-slate-500 uppercase mb-2 tracking-widest ml-1">Kata Sandi</label>
                            ...
                            <div>
                                <label class="block text-[9px] font-black text-slate-400 dark:text-slate-500 uppercase mb-2 tracking-widest ml-1">Konfirmasi Kata Sandi</label>
                ...
                <div class="bg-white dark:bg-slate-900 rounded-[2rem] border border-slate-100 dark:border-slate-800 shadow-sm overflow-hidden">
                    <div class="p-6 border-b dark:border-slate-800 bg-indigo-50/30 dark:bg-indigo-950/30 flex items-center gap-3">
                        ...
                        <div>
                            <h3 class="text-[11px] font-black text-indigo-900 dark:text-indigo-400 uppercase tracking-[0.2em]">Profil Instansi</h3>
                            <p class="text-[9px] text-slate-400 font-bold uppercase tracking-widest">Afiliasi Kerja Petugas</p>
                        </div>
                    </div>
                    <div class="p-8">
                        <label class="block text-[9px] font-black text-slate-400 dark:text-slate-500 uppercase mb-2 tracking-widest ml-1">Nama Instansi / Dinas / Desa</label>
            ...
            <div class="space-y-6">
                <div class="bg-white dark:bg-slate-900 rounded-[2rem] border border-slate-100 dark:border-slate-800 shadow-sm overflow-hidden">
                    <div class="p-6 border-b dark:border-slate-800 bg-amber-50/30 dark:bg-amber-950/30 flex items-center gap-3">
                        ...
                        <div>
                            <h3 class="text-[11px] font-black text-amber-900 dark:text-amber-400 uppercase tracking-[0.2em]">Otoritas</h3>
                            <p class="text-[9px] text-slate-400 font-bold uppercase tracking-widest">Hak Akses Sistem</p>
                        </div>
                    </div>
                    <div class="p-8 space-y-8">
                        <div>
                            <label class="block text-[9px] font-black text-slate-400 dark:text-slate-500 uppercase mb-3 tracking-widest ml-1">Pilih Role Utama</label>
                            <div class="space-y-2">
                                ...
                                <label class="flex items-center p-3.5 bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-xl cursor-pointer hover:border-blue-500 transition-all group">
                                    ...
                                    <div class="ml-3">
                                        <p class="text-xs font-black text-slate-700 dark:text-slate-200 uppercase tracking-tight group-hover:text-blue-600 transition-colors"><?= $role['role_name'] ?></p>
                        ...
                        <div id="desa-assignment" class="pt-6 border-t dark:border-slate-800">
                            <label class="block text-[9px] font-black text-slate-400 dark:text-slate-500 uppercase mb-3 tracking-widest ml-1">Penugasan Wilayah</label>
