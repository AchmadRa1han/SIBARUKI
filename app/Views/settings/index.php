...
<div class="space-y-10 pb-24">
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        ...
        <div class="flex items-center space-x-3 bg-blue-50 dark:bg-blue-900/20 px-6 py-3 rounded-2xl border border-blue-100 dark:border-blue-800">
            ...
            <span class="text-xs font-bold text-blue-900 dark:text-blue-400 uppercase tracking-widest">Administrator Mode</span>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <a href="<?= base_url('users') ?>" class="group relative bg-white dark:bg-slate-900 p-8 rounded-2xl border border-slate-100 dark:border-slate-800 shadow-sm hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 overflow-hidden">
            ...
            <div class="relative z-10 space-y-6">
                ...
                <div class="flex items-center text-blue-600 dark:text-blue-400 text-xs font-bold uppercase tracking-widest group-hover:gap-2 transition-all">
        ...
        <a href="<?= base_url('roles') ?>" class="group relative bg-white dark:bg-slate-900 p-8 rounded-2xl border border-slate-100 dark:border-slate-800 shadow-sm hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 overflow-hidden">
            ...
            <div class="relative z-10 space-y-6">
                ...
                <div>
                    <h3 class="text-xl font-bold text-blue-950 dark:text-white uppercase tracking-tight mb-2">Manajemen Role</h3>
                ...
                <div class="flex items-center text-indigo-600 dark:text-indigo-400 text-xs font-bold uppercase tracking-widest group-hover:gap-2 transition-all">
        ...
        <?php if(has_permission('manage_roles')): ?>
        <a href="<?= base_url('logs') ?>" class="group relative bg-white dark:bg-slate-900 p-8 rounded-2xl border border-slate-100 dark:border-slate-800 shadow-sm hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 overflow-hidden">
            ...
            <div class="relative z-10 space-y-6">
                ...
                <div>
                    <h3 class="text-xl font-bold text-blue-950 dark:text-white uppercase tracking-tight mb-2">Audit Trail</h3>
                ...
                <div class="flex items-center text-amber-600 dark:text-amber-400 text-xs font-bold uppercase tracking-widest group-hover:gap-2 transition-all">
        ...
        <!-- Recycle Bin -->
        <?php if(has_permission('manage_roles')): ?>
        <a href="<?= base_url('trash') ?>" class="group relative bg-white dark:bg-slate-900 p-8 rounded-2xl border border-slate-100 dark:border-slate-800 shadow-sm hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 overflow-hidden">
            ...
            <div class="relative z-10 space-y-6">
                ...
                <div>
                    <h3 class="text-xl font-bold text-blue-950 dark:text-white uppercase tracking-tight mb-2">Recycle Bin</h3>
                ...
                <div class="flex items-center text-rose-600 dark:text-rose-400 text-xs font-bold uppercase tracking-widest group-hover:gap-2 transition-all">
        ...
        <a href="<?= base_url('ref-master') ?>" class="group relative bg-white dark:bg-slate-900 p-8 rounded-2xl border border-slate-100 dark:border-slate-800 shadow-sm hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 overflow-hidden">
            ...
            <div class="relative z-10 space-y-6">
                ...
                <div>
                    <h3 class="text-xl font-bold text-blue-950 dark:text-white uppercase tracking-tight mb-2">Referensi Dropdown</h3>
                ...
                <div class="flex items-center text-emerald-600 dark:text-emerald-400 text-xs font-bold uppercase tracking-widest group-hover:gap-2 transition-all">
        ...
        <a href="<?= base_url('settings/carousel') ?>" class="group relative bg-white dark:bg-slate-900 p-8 rounded-2xl border border-slate-100 dark:border-slate-800 shadow-sm hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 overflow-hidden">
            ...
            <div class="relative z-10 space-y-6">
                ...
                <div>
                    <h3 class="text-xl font-bold text-blue-950 dark:text-white uppercase tracking-tight mb-2">Carousel Hero</h3>
        ...
        <a href="<?= base_url('rtlh/history-transformasi') ?>" class="group relative bg-white dark:bg-slate-900 p-8 rounded-2xl border border-slate-100 dark:border-slate-800 shadow-sm hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 overflow-hidden">
            <div class="absolute -right-4 -top-4 w-32 h-32 bg-indigo-50 dark:bg-indigo-900/10 rounded-full blur-3xl group-hover:bg-indigo-100 dark:group-hover:bg-indigo-900/20 transition-colors"></div>
            <div class="relative z-10 space-y-6">
                ...
                <div>
                    <h3 class="text-xl font-bold text-blue-950 dark:text-white uppercase tracking-tight mb-2">Histori Perubahan (RLH)</h3>
        ...
        <div class="group relative bg-slate-50/50 dark:bg-slate-950 p-8 rounded-2xl border border-dashed border-slate-200 dark:border-slate-800 transition-all duration-500">
            <div class="relative z-10 space-y-6 opacity-60 group-hover:opacity-100 transition-opacity">
                ...
                <div>
                    <h3 class="text-xl font-bold text-slate-400 dark:text-slate-500 uppercase tracking-tight mb-2">Profil Instansi</h3>
                ...
                <div class="bg-slate-100 dark:bg-slate-800/50 text-[9px] font-bold uppercase tracking-widest px-3 py-1 rounded-full w-fit text-slate-400">
                    Coming Soon
                </div>
            </div>
        </div>
