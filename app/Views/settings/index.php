    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <a href="<?= base_url('ref-master') ?>" class="group relative bg-white dark:bg-slate-900 p-8 rounded-[2.5rem] border border-slate-100 dark:border-slate-800 shadow-sm hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 overflow-hidden">
            ...
            <div class="relative z-10 space-y-6">
                ...
                <div>
                    <h3 class="text-xl font-black text-blue-950 dark:text-white uppercase tracking-tight mb-2">Referensi Dropdown Data Perumahan</h3>
                    <p class="text-sm text-slate-500 dark:text-slate-400 leading-relaxed font-medium">Kelola pilihan dropdown instrumen teknis (Material, Kondisi, Jenis Kelamin, dll).</p>
                </div>
