...
<div class="max-w-7xl mx-auto space-y-6 pb-32 text-slate-900 dark:text-slate-200">
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 bg-white dark:bg-slate-900 p-6 rounded-[2rem] border border-slate-100 dark:border-slate-800 shadow-sm transition-all duration-300 relative overflow-hidden">
        ...
        <div class="relative z-10 flex items-center gap-5">
            ...
            <div>
                <h1 class="text-2xl md:text-3xl font-black text-blue-950 dark:text-white uppercase tracking-tighter">Tambah PISEW</h1>
        ...
        <div class="flex items-center gap-3 relative z-10">
            <a href="<?= base_url('pisew') ?>" class="px-5 py-2.5 bg-slate-100 dark:bg-slate-800 text-slate-500 dark:text-slate-400 rounded-xl text-[10px] font-black uppercase tracking-widest hover:bg-slate-200 dark:hover:bg-slate-700 transition-all active:scale-95">Batal</a>
        </div>
    </div>
    ...
    <form action="<?= base_url('pisew/store') ?>" method="post">
        ...
        <div class="bg-white dark:bg-slate-900 rounded-[2rem] border border-slate-100 dark:border-slate-800 shadow-sm overflow-hidden transition-all duration-300">
            <div class="p-6 border-b dark:border-slate-800 bg-indigo-50/30 dark:bg-indigo-950/30 flex items-center gap-3">
                ...
                <div>
                    <h3 class="text-[11px] font-black text-indigo-900 dark:text-indigo-400 uppercase tracking-[0.2em]">Rincian Kegiatan PISEW</h3>
            ...
            <div class="p-8 grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div class="bg-indigo-50 dark:bg-indigo-950/30 p-6 rounded-2xl border border-indigo-100 dark:border-indigo-900/50">
                    ...
                    <input type="number" name="anggaran" required class="w-full bg-transparent border-none text-xl font-black text-indigo-950 dark:text-white p-0 focus:ring-0 outline-none placeholder:opacity-20" placeholder="0">
                </div>
                <div>
        ...
        <div class="flex flex-col md:flex-row justify-between items-center gap-6 pt-4">
            ...
            <button type="submit" class="group flex items-center space-x-6 bg-indigo-600 hover:bg-indigo-700 text-white pl-8 pr-4 py-4 rounded-[1.5rem] font-black shadow-xl shadow-indigo-600/20 transition-all active:scale-95 w-full md:w-auto">
