                    ...
                    <tr class="group hover:bg-slate-50/80 dark:hover:bg-slate-800/30 transition-all duration-200">
                        ...
                        <td class="px-4 py-3 text-center">
                            <div class="flex items-center justify-center gap-1.5">
                                ...
                                <a href="<?= base_url('pisew/edit/'.$item['id']) ?>" class="p-2 bg-amber-500 text-white rounded-lg shadow-md hover:bg-amber-600 transition-all active:scale-95" title="Edit"><i data-lucide="edit-3" class="w-3.5 h-3.5"></i></a>
