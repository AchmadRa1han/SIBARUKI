...
<div class="max-w-7xl mx-auto space-y-6 pb-32 text-slate-900 dark:text-slate-200">
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 bg-white dark:bg-slate-900 p-6 rounded-[2rem] border border-slate-100 dark:border-slate-800 shadow-sm transition-all duration-300 relative overflow-hidden">
        ...
        <div class="flex items-center gap-3 relative z-10">
            <a href="<?= base_url('wilayah-kumuh/detail/' . $kumuh['FID']) ?>" class="px-5 py-2.5 bg-slate-100 dark:bg-slate-800 text-slate-500 dark:text-slate-400 rounded-xl text-[10px] font-black uppercase tracking-widest hover:bg-slate-200 dark:hover:bg-slate-700 transition-all active:scale-95">Batal</a>
        </div>
    </div>
        ...
        <div class="space-y-10">
            ...
            <div class="bg-white dark:bg-slate-900 rounded-[2rem] border border-slate-100 dark:border-slate-800 shadow-sm overflow-hidden transition-all duration-300">
                <div class="p-6 border-b dark:border-slate-800 bg-amber-50/30 dark:bg-amber-950/30 flex items-center gap-3">
                    ...
                    <div>
                        <h3 class="text-[11px] font-black text-amber-900 dark:text-amber-400 uppercase tracking-[0.2em]">Data Administrasi</h3>
                ...
                <div class="p-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div class="bg-blue-50 dark:bg-blue-950/30 p-5 rounded-2xl border border-blue-100 dark:border-blue-900/50">
                        ...
                        <input type="number" step="0.01" name="Luas_kumuh" value="<?= old('Luas_kumuh', $kumuh['Luas_kumuh']) ?>" required class="w-full bg-transparent border-none text-xl font-black text-blue-950 dark:text-white p-0 focus:ring-0 outline-none">
                    </div>
                    <div class="bg-rose-50 dark:bg-rose-950/30 p-5 rounded-2xl border border-rose-100 dark:border-rose-900/50">
                        <label class="block text-[8px] font-black text-rose-900 dark:text-rose-400 uppercase mb-2 tracking-widest ml-1">Skor Kekumuhan</label>
                        <input type="number" step="0.01" name="skor_kumuh" value="<?= old('skor_kumuh', $kumuh['skor_kumuh']) ?>" required class="w-full bg-transparent border-none text-xl font-black text-rose-950 dark:text-white p-0 focus:ring-0 outline-none italic">
                    </div>
                </div>
            </div>
                ...
                <div class="p-8 space-y-8">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <div class="absolute right-3 bottom-3 text-[8px] font-black text-slate-400 uppercase tracking-widest pointer-events-none">Sistem Koordinat: WGS84</div>
                        </div>
                    </div>
                </div>
            </div>
