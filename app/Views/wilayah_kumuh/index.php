    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-6 bg-blue-950 p-10 rounded-[2.5rem] text-white shadow-2xl shadow-blue-950/20 relative overflow-hidden transition-all duration-500">
        ...
        <div class="relative z-10 flex items-center gap-5">
            <div class="w-14 h-14 bg-white/10 rounded-2xl flex items-center justify-center backdrop-blur-md border border-white/10 shadow-inner">
                <i data-lucide="map" class="w-7 h-7 text-rose-400"></i>
            </div>
            <div>
                <h1 class="text-3xl md:text-4xl font-black uppercase tracking-tighter leading-none">Wilayah Kumuh</h1>
                <p class="text-white/60 font-medium text-xs mt-2 tracking-wide">Monitoring dan pemetaan kawasan permukiman kumuh Kabupaten Sinjai</p>
            </div>
        </div>
        <div class="flex flex-wrap items-center gap-3 relative z-10">
            <a href="<?= base_url('wilayah-kumuh/export-excel') ?>" class="bg-emerald-600 text-white px-4 py-2 rounded-xl text-[9px] font-bold uppercase tracking-widest shadow-xl shadow-emerald-600/20 hover:bg-emerald-700 transition-all active:scale-95 flex items-center gap-2">
                <i data-lucide="file-spreadsheet" class="w-4 h-4"></i> Export Excel
            </a>
            <?php if (has_permission('create_kumuh')): ?>
            <a href="<?= base_url('wilayah-kumuh/create') ?>" class="bg-white text-blue-950 px-4 py-2 rounded-xl text-[9px] font-black uppercase tracking-widest shadow-xl hover:scale-105 active:scale-95 transition-all flex items-center gap-2 group">
