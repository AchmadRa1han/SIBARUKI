...
<div class="max-w-7xl mx-auto space-y-6 pb-24 text-slate-900 dark:text-slate-200">
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-6 bg-white dark:bg-slate-900 p-8 rounded-2xl border border-slate-100 dark:border-slate-800 shadow-sm transition-all duration-300 relative overflow-hidden">
        ...
        <div class="relative z-10">
            <h1 class="text-3xl font-bold text-blue-950 dark:text-white uppercase tracking-tighter leading-tight">Edit Jaringan Jalan</h1>
            <p class="text-[10px] text-slate-500 font-bold uppercase tracking-[0.2em] mt-1">ID Aset: #<?= $jalan['id'] ?></p>
        </div>
                ...
                <div class="bg-white dark:bg-slate-900 rounded-3xl p-8 shadow-sm border border-slate-100 dark:border-slate-800 transition-all duration-300">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div class="md:col-span-2">
                            ...
                            <input type="text" name="nama_jalan" value="<?= old('nama_jalan', $jalan['nama_jalan']) ?>" class="w-full p-4 bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-2xl focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 dark:text-white outline-none transition-all font-bold" required>
                        </div>
                        
                        <div>
                            <label class="block text-[9px] font-bold text-slate-400 uppercase mb-3 tracking-widest ml-1">Tahun Pembangunan</label>
                            <input type="number" name="tahun" value="<?= old('tahun', $jalan['tahun']) ?>" min="2000" max="2100" class="w-full p-4 bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-2xl focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 dark:text-white outline-none transition-all font-bold" required>
                        </div>

                        <div>
                            <label class="block text-[9px] font-bold text-slate-400 uppercase mb-3 tracking-widest ml-1">Panjang / Luas Capaian</label>
                            <div class="relative">
                                <input type="number" step="0.01" name="panjang_luas" value="<?= old('panjang_luas', $jalan['panjang_luas']) ?>" class="w-full p-4 pr-16 bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-2xl focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 dark:text-white outline-none transition-all font-bold" required>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input type="text" name="jalan" value="<?= old('jalan', $jalan['jalan']) ?>" class="w-full p-4 bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-2xl focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 dark:text-white outline-none transition-all font-bold" required>
                        </div>
                    </div>
                </div>
                            ...
                            <div id="preview_before" class="relative group aspect-video bg-slate-50 dark:bg-slate-950 border-2 border-dashed border-slate-200 dark:border-slate-800 rounded-3xl flex flex-col items-center justify-center overflow-hidden transition-all hover:border-blue-500/50">
                                ...
                                <?php else: ?>
                                    <div class="flex flex-col items-center justify-center text-center p-6">
                                        <i data-lucide="camera" class="w-6 h-6 text-slate-400 mb-2"></i>
                                        <p class="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Update Foto Before</p>
                                    </div>
                                <?php endif; ?>
                            </div>
                        </div>
                        <div class="space-y-4">
                            ...
                            <div id="preview_after" class="relative group aspect-video bg-slate-50 dark:bg-slate-950 border-2 border-dashed border-slate-200 dark:border-slate-800 rounded-3xl flex flex-col items-center justify-center overflow-hidden transition-all hover:border-emerald-500/50">
                                ...
                                <?php else: ?>
                                    <div class="flex flex-col items-center justify-center text-center p-6">
                                        <i data-lucide="camera" class="w-6 h-6 text-slate-400 mb-2"></i>
                                        <p class="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Update Foto After</p>
                                    </div>
                                <?php endif; ?>
                            </div>
                        </div>
            ...
            <div class="space-y-6">
                <div class="bg-white dark:bg-slate-900 rounded-3xl border border-slate-100 dark:border-slate-800 shadow-sm overflow-hidden h-full flex flex-col min-h-[500px]">
                    ...
                    <div class="p-6 bg-slate-50 dark:bg-slate-950">
                        ...
                        <textarea id="wkt-input" name="wkt" rows="3" class="w-full p-4 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl text-[10px] font-mono text-blue-600 outline-none" required><?= old('wkt', $jalan['wkt']) ?></textarea>
                    </div>
                </div>
            </div>
        </div>
