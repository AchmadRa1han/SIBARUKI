    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-6 bg-white dark:bg-slate-900 p-6 rounded-2xl border border-slate-100 dark:border-slate-800 shadow-sm relative overflow-hidden transition-all duration-300">
        ...
        <div class="relative z-10 flex items-center gap-4">
            ...
            <div>
                ...
                <p class="text-slate-500 dark:text-slate-400 font-medium text-xs mt-1">Pencatatan aset infrastruktur jaringan jalan baru.</p>
            </div>
        </div>
            ...
            <div class="lg:col-span-2 space-y-6">
                <div class="bg-white dark:bg-slate-900 rounded-2xl border border-slate-100 dark:border-slate-800 shadow-sm overflow-hidden transition-all duration-300">
                    <div class="p-6 border-b dark:border-slate-800 bg-blue-50/30 dark:bg-blue-950/30 flex items-center gap-3">
                        ...
                        <div>
                            <h3 class="text-[11px] font-bold text-blue-900 dark:text-blue-400 uppercase tracking-[0.2em]">Informasi Umum</h3>
                    ...
                    <div class="p-8 grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="md:col-span-2">
                            ...
                            <input type="text" name="nama_jalan" value="<?= old('nama_jalan') ?>" required placeholder="Contoh: Pembangunan Jalan Beton Ruas A..." class="w-full p-3.5 bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-xl focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 dark:text-slate-200 outline-none transition-all font-bold">
                        </div>
                        
                        <div>
                            <label class="block text-[9px] font-bold text-slate-400 uppercase mb-2 tracking-widest ml-1">Tahun Pembangunan</label>
                            <input type="number" name="tahun" value="<?= old('tahun', date('Y')) ?>" min="2000" max="2100" required class="w-full p-3.5 bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-xl focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 dark:text-slate-200 outline-none transition-all font-bold">
                        </div>

                        <div>
                            <label class="block text-[9px] font-bold text-slate-400 uppercase mb-2 tracking-widest ml-1">Panjang / Luas Capaian</label>
                            <div class="relative">
                                <input type="number" step="0.01" name="panjang_luas" value="<?= old('panjang_luas') ?>" required placeholder="0.00" class="w-full p-3.5 bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-xl focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 dark:text-slate-200 outline-none transition-all font-bold">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input type="text" name="jalan" value="<?= old('jalan') ?>" required placeholder="Contoh: Kelurahan Lappa, Kec. Sinjai Utara" class="w-full p-3.5 bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-xl focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 dark:text-slate-200 outline-none transition-all font-bold">
                        </div>
                    </div>
                </div>
                        ...
                        <div class="space-y-3">
                            ...
                            <div id="preview_before" class="relative group aspect-video bg-slate-50 dark:bg-slate-950 border-2 border-dashed border-slate-200 dark:border-slate-800 rounded-2xl flex flex-col items-center justify-center overflow-hidden transition-all hover:border-blue-500/50">
                                ...
                                <div class="text-center p-6">
                                    ...
                                    <p class="text-[8px] font-bold text-slate-400 uppercase tracking-widest">Pilih Foto Kondisi 0%</p>
                                </div>
                            </div>
                        </div>
                        <div class="space-y-3">
                            ...
                            <div id="preview_after" class="relative group aspect-video bg-slate-50 dark:bg-slate-950 border-2 border-dashed border-slate-200 dark:border-slate-800 rounded-2xl flex flex-col items-center justify-center overflow-hidden transition-all hover:border-emerald-500/50">
                                ...
                                <div class="text-center p-6">
                                    <i data-lucide="image-plus" class="w-8 h-8 text-slate-300 mx-auto mb-2 group-hover:scale-110 transition-transform"></i>
                                    <p class="text-[8px] font-bold text-slate-400 uppercase tracking-widest">Pilih Foto Kondisi 100%</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="space-y-6">
                <div class="bg-white dark:bg-slate-900 rounded-2xl border border-slate-100 dark:border-slate-800 shadow-sm overflow-hidden h-full flex flex-col min-h-[500px]">
                    ...
                    <div class="p-6 bg-slate-50 dark:bg-slate-950">
                        ...
                        <textarea id="wkt-input" name="wkt" rows="2" readonly required class="w-full p-4 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl text-[10px] font-mono text-blue-600 outline-none transition-all placeholder:opacity-30" placeholder="Klik pada peta..."><?= old('wkt') ?></textarea>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    ...
    function initMap() {
        map = L.map('map-input', { zoomControl: false }).setView([-5.1245, 120.2536], 11);
