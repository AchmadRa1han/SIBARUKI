...
<div class="max-w-2xl mx-auto bg-white p-8 rounded-lg shadow-md">
    <h1 class="text-2xl font-semibold text-gray-800 mb-6">Tambah Ref Master</h1>

    <form action="<?= base_url('ref-master/store') ?>" method="post">
        <?= csrf_field() ?>
        ...
        <div class="mb-4">
            ...
            <input type="text" name="kategori" value="<?= old('kategori') ?>" 
                   ...
                   placeholder="Contoh: hobi, jenis_kelamin">
        ...
        <div class="mb-6">
            ...
            <input type="text" name="nama_pilihan" value="<?= old('nama_pilihan') ?>" 
                   ...
                   placeholder="Contoh: Membaca, Laki-laki">
