...
<div class="max-w-2xl mx-auto">
    <div class="bg-white dark:bg-slate-900 rounded-2xl border border-slate-100 dark:border-slate-800 shadow-sm overflow-hidden transition-colors duration-300">
        <div class="p-8 border-b dark:border-slate-800 bg-slate-50/50 dark:bg-slate-950/50 flex justify-between items-center">
            <div>
                <h1 class="text-2xl font-bold text-blue-950 dark:text-white uppercase tracking-wider">Tambah Referensi</h1>
        ...
        <form action="<?= base_url('ref-master/store') ?>" method="post" class="p-10 space-y-8">
            ...
            <div class="pt-8 flex justify-end gap-6 border-t border-slate-50 dark:border-slate-800">
                ...
                <button type="submit" class="bg-blue-950 dark:bg-blue-700 text-white px-10 py-4 rounded-2xl font-bold text-xs uppercase tracking-[0.2em] shadow-xl shadow-blue-950/20 dark:shadow-none hover:bg-blue-900 dark:hover:bg-blue-600 transition-all">
                    Simpan Referensi
                </button>
            </div>
        </form>
