        ...
        <div class="overflow-x-auto">
            <table class="w-full text-left border-collapse">
                ...
                <tbody class="divide-y dark:divide-slate-800">
                    <?php if(empty($trash)): ?>
                        <tr><td colspan="4" class="px-8 py-20 text-center opacity-20 font-black uppercase text-xs tracking-[0.3em]">Recycle Bin Kosong</td></tr>
                    <?php endif; ?>
                    ...
                    <tr class="group hover:bg-slate-50/80 dark:hover:bg-slate-800/30 transition-all duration-300">
                        ...
                        <td class="px-8 py-6">
                            <div class="flex justify-center gap-3">
                                <button onclick="handleRestore('<?= base_url('trash/restore/'.$item['id']) ?>')" class="px-5 py-2 bg-emerald-600 text-white rounded-xl text-[10px] font-black uppercase tracking-widest shadow-lg shadow-emerald-600/20 hover:scale-105 active:scale-95 transition-all">
                                    Restore
                                </button>
                                <button onclick="handleDeletePerm('<?= base_url('trash/delete-perm/'.$item['id']) ?>')" class="px-5 py-2 bg-rose-500 text-white rounded-xl text-[10px] font-black uppercase tracking-widest shadow-lg shadow-rose-500/20 hover:scale-105 active:scale-95 transition-all">
                                    Permanent
                                </button>
                            </div>
                        </td>
