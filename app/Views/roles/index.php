...
<div class="p-6">
    <div class="flex justify-between items-center mb-8">
        <div class="relative z-10 flex items-center gap-4">
            ...
            <div>
                <h1 class="text-3xl font-bold text-blue-950 dark:text-white uppercase tracking-tight">Manajemen Role</h1>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <?php foreach ($roles as $role) : ?>
            <div class="bg-white dark:bg-slate-900 p-8 rounded-2xl border border-slate-100 dark:border-slate-800 shadow-sm hover:shadow-xl hover:shadow-blue-900/5 transition-all group relative overflow-hidden">
                ...
                <div class="relative z-10">
                    <div class="flex justify-between items-start mb-6">
                        <div>
                            <span class="text-[10px] font-bold text-blue-900 dark:text-blue-400 uppercase tracking-widest bg-blue-50 dark:bg-blue-950/30 px-3 py-1 rounded-full border border-blue-100 dark:border-blue-900 mb-2 inline-block transition-colors">Role Name</span>
                    ...
                    <div class="space-y-4 mb-8">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <p class="text-[10px] font-bold text-blue-900 dark:text-blue-400 uppercase tracking-widest transition-colors">Scope</p>
