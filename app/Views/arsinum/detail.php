...
<div class="max-w-7xl mx-auto space-y-6 pb-12 text-slate-900 dark:text-slate-200">
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-6 bg-white dark:bg-slate-900 p-8 rounded-[2rem] border border-slate-100 dark:border-slate-800 shadow-sm transition-all duration-300 relative overflow-hidden">
        ...
        <div class="flex items-center gap-2 relative z-10">
            <a href="<?= base_url('arsinum/edit/'.$item['id']) ?>" class="px-5 py-2.5 bg-amber-500 hover:bg-amber-600 text-white rounded-xl text-[10px] font-black uppercase tracking-widest shadow-lg shadow-amber-500/20 transition-all active:scale-95 flex items-center gap-2">
            ...
            <div class="bg-white dark:bg-slate-900 rounded-[2rem] p-8 shadow-sm border border-slate-100 dark:border-slate-800 relative overflow-hidden transition-all duration-300">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-y-8 gap-x-10 relative z-10">
                    <div class="md:col-span-2">
                        <p class="text-[9px] font-black text-slate-400 uppercase tracking-widest mb-2">Jenis Pekerjaan</p>
                        <p class="text-lg font-black text-slate-800 dark:text-slate-100 uppercase tracking-tight"><?= $item['jenis_pekerjaan'] ?></p>
                    </div>
                    <div>
                    ...
                    <div>
                        <p class="text-[9px] font-black text-slate-400 uppercase tracking-widest mb-2">Desa / Kelurahan</p>
                        <p class="text-sm font-black text-slate-800 dark:text-slate-100 uppercase tracking-wider"><?= $item['desa'] ?></p>
                    </div>
                    <div>
                        <p class="text-[9px] font-black text-slate-400 uppercase tracking-widest mb-2">Volume Output</p>
                        <span class="inline-block px-4 py-1.5 bg-blue-50 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 text-[10px] font-black uppercase rounded-lg border border-blue-100 dark:border-blue-800 shadow-sm">
                            <?= $item['volume'] ?>
                        </span>
                    </div>
                    <div>
                        <p class="text-[9px] font-black text-slate-400 uppercase tracking-widest mb-2">Periode Pelaksanaan</p>
                        <p class="text-sm font-black text-slate-800 dark:text-slate-100 uppercase tracking-widest"><?= $item['tahun'] ?></p>
                    </div>
                    <div class="md:col-span-2 pt-4">
                        <p class="text-[9px] font-black text-slate-400 uppercase tracking-widest mb-3">Pelaksana / Kontraktor</p>
            ...
            <div class="bg-white dark:bg-slate-900 rounded-[2rem] p-8 shadow-sm border border-slate-100 dark:border-slate-800 transition-all duration-300">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="bg-emerald-50 dark:bg-emerald-950/20 p-6 rounded-[1.5rem] border border-emerald-100 dark:border-emerald-900/30 shadow-sm">
                        <p class="text-[9px] font-black text-emerald-600/70 uppercase tracking-widest mb-2">Total Pagu Anggaran</p>
                        <p class="text-3xl font-black text-emerald-600 tracking-tighter italic">Rp <?= number_format($item['anggaran'], 0, ',', '.') ?></p>
                    </div>
                    <div class="bg-blue-50 dark:bg-blue-950/20 p-6 rounded-[1.5rem] border border-blue-100 dark:border-blue-900/30 shadow-sm">
                        <p class="text-[9px] font-black text-blue-600/70 uppercase tracking-widest mb-2">Sumber Pendanaan</p>
                        <p class="text-xs font-black text-blue-900 dark:text-blue-400 uppercase tracking-widest"><?= $item['sumber_dana'] ?: '-' ?></p>
                    </div>
                </div>
            </div>
        </div>
