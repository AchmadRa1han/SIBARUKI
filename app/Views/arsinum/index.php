...
<div class="space-y-6 pb-12 text-slate-900 dark:text-slate-200">
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-6 bg-blue-950 p-7 rounded-[2.5rem] text-white shadow-2xl shadow-blue-950/20 relative overflow-hidden transition-all duration-500">
        ...
        <div class="flex flex-wrap items-center gap-2 relative z-10">
            <a href="<?= base_url('arsinum/export-excel') ?>" class="bg-emerald-600 text-white px-3.5 py-2 rounded-xl text-[9px] font-bold uppercase tracking-widest shadow-xl shadow-emerald-600/20 hover:bg-emerald-700 transition-all active:scale-95 flex items-center gap-1.5">
            ...
            arsinumData.forEach(item => {
                if (item.koordinat) {
                    ...
                    if (coords.length === 2 && !isNaN(coords[0]) && !isNaN(coords[1])) {
                        ...
                        marker.bindPopup(`
                            <div class="bg-blue-950 text-white p-3 rounded-t-xl border-b border-white/10"><p class="text-[7px] font-bold uppercase tracking-[0.2em] text-blue-400 mb-1">Arsinum</p><h5 class="text-[11px] font-bold uppercase leading-tight">${item.jenis_pekerjaan}</h5></div>
