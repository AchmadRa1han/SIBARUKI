...
<div class="max-w-7xl mx-auto space-y-6 pb-32 text-slate-900 dark:text-slate-200">
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 bg-white dark:bg-slate-900 p-6 rounded-[2rem] border border-slate-100 dark:border-slate-800 shadow-sm transition-all duration-300 relative overflow-hidden">
        ...
        <div class="relative z-10 flex items-center gap-5">
            ...
            <div>
                <h1 class="text-2xl md:text-3xl font-black text-blue-950 dark:text-white uppercase tracking-tighter">Perbarui Data RTLH</h1>
                <div class="flex items-center gap-2 mt-1">
                    <span class="text-[9px] font-black text-slate-400 uppercase tracking-widest">ID Registrasi:</span>
        ...
        <div class="flex items-center gap-3 relative z-10">
            <a href="<?= base_url('rtlh/detail/' . $rumah['id_survei']) ?>" class="px-5 py-2.5 bg-slate-100 dark:bg-slate-800 text-slate-500 dark:text-slate-400 rounded-xl text-[10px] font-black uppercase tracking-widest hover:bg-slate-200 dark:hover:bg-slate-700 transition-all active:scale-95">Batal</a>
        </div>
    </div>
            ...
            <div class="bg-white dark:bg-slate-900 rounded-[2rem] border border-slate-100 dark:border-slate-800 shadow-sm overflow-hidden transition-all duration-300">
                ...
                <div class="p-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    <div class="bg-indigo-50 dark:bg-indigo-950/30 p-5 rounded-2xl border border-indigo-100 dark:border-indigo-900/50">
                        ...
                        <input type="number" step="0.01" name="luas_rumah_m2" value="<?= old('luas_rumah_m2', $rumah['luas_rumah_m2']) ?>" class="w-full bg-transparent border-none text-xl font-black text-indigo-950 dark:text-white p-0 focus:ring-0 outline-none">
                    </div>
                    <div class="bg-indigo-50 dark:bg-indigo-950/30 p-5 rounded-2xl border border-indigo-100 dark:border-indigo-900/50">
                        ...
                        <input type="number" step="0.01" name="luas_lahan_m2" value="<?= old('luas_lahan_m2', $rumah['luas_lahan_m2']) ?>" class="w-full bg-transparent border-none text-xl font-black text-indigo-950 dark:text-white p-0 focus:ring-0 outline-none">
                    </div>
                    <div>
                    ...
                    <div>
                        <label class="block text-[9px] font-black text-slate-400 dark:text-slate-500 uppercase mb-2 tracking-widest ml-1">Fungsi Ruang</label>
                    ...
                    <div>
                        <label class="block text-[9px] font-black text-slate-400 dark:text-slate-500 uppercase mb-2 tracking-widest ml-1">Kepemilikan Tanah</label>
                    ...
                    <div>
                        <label class="block text-[9px] font-black text-slate-400 dark:text-slate-500 uppercase mb-2 tracking-widest ml-1">Status Backlog</label>
                    ...
                    <div>
                        <label class="block text-[9px] font-black text-slate-400 dark:text-slate-500 uppercase mb-2 tracking-widest ml-1">Desil Nasional</label>
                ...
                <div class="bg-white dark:bg-slate-900 rounded-[2rem] border border-slate-100 dark:border-slate-800 shadow-sm overflow-hidden transition-all duration-300">
                    <div class="p-6 border-b dark:border-slate-800 bg-rose-50/30 dark:bg-rose-950/30 flex items-center justify-between">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <h3 class="text-[11px] font-black text-rose-950 dark:text-rose-400 uppercase tracking-[0.2em]">Titik Koordinat</h3>
                    ...
                    <div class="p-4 space-y-3">
                        <div class="flex items-center justify-between px-1">
                            <label class="text-[8px] font-black text-slate-400 uppercase tracking-widest">Well-Known Text (WKT)</label>
                            <button type="button" onclick="syncFromText()" class="text-[8px] font-black text-blue-600 uppercase tracking-widest flex items-center gap-1 hover:underline">
                                <i data-lucide="refresh-cw" class="w-2.5 h-2.5"></i> Sinkronkan
                            </button>
                        </div>
                        <input type="text" name="lokasi_koordinat" id="lokasi_koordinat" value="<?= old('lokasi_koordinat', $rumah['lokasi_koordinat']) ?>" class="w-full p-3 bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-xl text-[10px] font-mono font-black text-rose-600 dark:text-rose-400 outline-none">
                    </div>
                </div>
            </div>
                                ...
                                <div id="<?= $f_key ?>_preview" class="w-full h-32 bg-slate-50 dark:bg-slate-950 border-2 <?= $hasPhoto ? 'border-solid border-blue-600/50' : 'border-dashed border-slate-200 dark:border-slate-800' ?> rounded-2xl flex flex-col items-center justify-center overflow-hidden transition-all group-hover:border-blue-600 group-hover:bg-blue-50/5">
                                    <?php if($hasPhoto): ?>
                                        ...
                                        <div class="absolute inset-0 bg-blue-950/40 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
                                            <span class="px-3 py-1.5 bg-white/20 backdrop-blur-md rounded-lg text-[7px] font-black text-white uppercase tracking-widest border border-white/30">Ganti Foto</span>
                                        </div>
                                    <?php else: ?>
                                        <i data-lucide="image-plus" class="w-6 h-6 text-slate-300 mb-1.5"></i>
                                        <span class="text-[7px] font-black text-slate-400 uppercase tracking-widest">Pilih Foto</span>
                                    <?php endif; ?>
                                </div>
                            </div>
                        </div>
