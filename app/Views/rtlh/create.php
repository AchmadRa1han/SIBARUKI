                ...
                <div class="p-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    <div>
                        ...
                        <select name="penghasilan_per_bulan" onchange="toggleLainnya(this, 'penghasilan_per_bulan_manual')" class="w-full p-3.5 bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-xl focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 dark:text-slate-200 outline-none transition-all appearance-none font-bold">
                            ...
                            <?php if(isset($master['PENGHASILAN'])): foreach($master['PENGHASILAN'] as $p): ?>
                                <option value="<?= $p['id'] ?>"><?= $p['nama_pilihan'] ?></option>
                            <?php endforeach; endif; ?>
                            <option value="lainnya">Lainnya...</option>
                        </select>
                        <input type="text" name="penghasilan_per_bulan_manual" id="penghasilan_per_bulan_manual" placeholder="Sebutkan penghasilan..." class="hidden w-full mt-2 p-3.5 bg-amber-50 dark:bg-amber-950/30 border border-amber-200 dark:border-amber-900 rounded-xl focus:ring-4 focus:ring-amber-500/10 focus:border-amber-500 dark:text-slate-200 outline-none transition-all font-bold text-sm animate-in fade-in slide-in-from-top-1">
                    </div>
                    <div>
            ...
            <div class="bg-white dark:bg-slate-900 rounded-2xl border border-slate-100 dark:border-slate-800 shadow-sm overflow-hidden transition-all duration-300">
                ...
                <div class="p-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    <div class="bg-indigo-50 dark:bg-indigo-950/30 p-5 rounded-2xl border border-indigo-100 dark:border-indigo-900/50">
                        ...
                        <input type="number" step="0.01" name="luas_rumah_m2" value="0" class="w-full bg-transparent border-none text-xl font-bold text-indigo-950 dark:text-white p-0 focus:ring-0 outline-none">
                    </div>
                    <div class="bg-indigo-50 dark:bg-indigo-950/30 p-5 rounded-2xl border border-indigo-100 dark:border-indigo-900/50">
                        ...
                        <input type="number" step="0.01" name="luas_lahan_m2" value="0" class="w-full bg-transparent border-none text-xl font-bold text-indigo-950 dark:text-white p-0 focus:ring-0 outline-none">
                    </div>
                    <div>
                ...
                <div class="bg-white dark:bg-slate-900 rounded-2xl border border-slate-100 dark:border-slate-800 shadow-sm overflow-hidden transition-all duration-300">
                    <div class="p-6 border-b dark:border-slate-800 bg-rose-50/30 dark:bg-rose-950/30 flex items-center justify-between">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <h3 class="text-[11px] font-bold text-rose-950 dark:text-rose-400 uppercase tracking-[0.2em]">Koordinat</h3>
                    ...
                    <div class="p-4">
                        <input type="text" name="lokasi_koordinat" id="lokasi_koordinat" required placeholder="POINT(Long Lat)" class="w-full p-3 bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-xl text-[10px] font-mono font-bold text-rose-600 dark:text-rose-400 placeholder:opacity-30 outline-none">
                    </div>
                </div>
            </div>
