...
<div class="max-w-7xl mx-auto space-y-6 pb-12 text-slate-900 dark:text-slate-200">
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-6 bg-white dark:bg-slate-900 p-6 rounded-2xl border border-slate-100 dark:border-slate-800 shadow-sm transition-all duration-300 relative overflow-hidden">
        ...
        <div class="relative z-10">
            <h1 class="text-2xl md:text-3xl font-bold text-blue-950 dark:text-white uppercase tracking-tighter">Histori Transformasi</h1>
    ...
    <div class="grid grid-cols-1 gap-6">
        ...
        ?>
        <div class="bg-white dark:bg-slate-900 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-800 overflow-hidden transition-all duration-300">
            <!-- Card Header -->
            <div class="p-6 border-b dark:border-slate-800 bg-slate-50/50 dark:bg-slate-950/50 flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h3 class="text-base font-bold text-blue-950 dark:text-white uppercase tracking-tight"><?= $item['nama_penerima'] ?></h3>
                ...
                <div class="flex flex-wrap gap-2">
                    <div class="px-4 py-2 bg-emerald-50 dark:bg-emerald-900/30 text-emerald-600 dark:text-emerald-400 rounded-xl text-[9px] font-bold uppercase tracking-widest border border-emerald-100 dark:border-emerald-800">
                        Program: <?= $item['sumber_bantuan'] ?>
                    </div>
                    <div class="px-4 py-2 bg-blue-50 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 rounded-xl text-[9px] font-bold uppercase tracking-widest border border-blue-100 dark:border-blue-800">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 relative">
                    ...
                    <div class="space-y-6">
                        <div class="flex items-center gap-3 mb-4">
                            <span class="w-8 h-8 bg-amber-100 dark:bg-amber-900/30 text-amber-600 rounded-lg flex items-center justify-center font-bold text-xs shadow-sm">01</span>
                            <div>
                                <h4 class="text-[10px] font-bold text-amber-600 uppercase tracking-[0.3em]">Kondisi Awal</h4>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                            ...
                            <div class="p-4 bg-slate-50 dark:bg-slate-950 rounded-xl border border-slate-100 dark:border-slate-800/50">
                                <p class="text-[8px] font-bold text-slate-400 uppercase mb-1.5 tracking-widest"><?= $f['label'] ?></p>
                                <p class="text-[10px] font-bold text-slate-700 dark:text-white uppercase tracking-wider"><?= $f['val'] ?></p>
                            </div>
                            <?php endforeach; ?>
                        </div>

                        <div class="p-5 bg-slate-50 dark:bg-slate-950 rounded-2xl border border-slate-100 dark:border-slate-800/50 space-y-4">
                            <h5 class="text-[8px] font-bold text-slate-400 uppercase tracking-[0.2em] border-b border-slate-200 dark:border-slate-800 pb-2 flex items-center gap-2">
                                <i data-lucide="info" class="w-3 h-3"></i> Fasilitas & Dimensi
                            </h5>
                            <div class="grid grid-cols-2 gap-y-4 gap-x-6">
                                <div>
                                    <p class="text-[7px] font-bold text-slate-400 uppercase mb-0.5 tracking-widest">Luas</p>
                    ...
                    <div class="space-y-6">
                        <div class="flex items-center gap-3 mb-4">
                            <span class="w-8 h-8 bg-emerald-100 dark:bg-emerald-900/30 text-emerald-600 rounded-lg flex items-center justify-center font-bold text-xs shadow-sm">02</span>
                            <div>
                                <h4 class="text-[10px] font-bold text-emerald-600 uppercase tracking-[0.3em]">Kondisi Akhir</h4>
                        ...
                        <div class="bg-emerald-50 dark:bg-emerald-950/30 p-6 rounded-2xl border border-emerald-100 dark:border-emerald-900/30 relative overflow-hidden group h-full flex flex-col justify-center">
                            ...
                            <div class="flex items-start gap-4 relative z-10">
                                ...
                                <div>
                                    <p class="text-[9px] font-bold text-emerald-800 dark:text-emerald-400 uppercase tracking-[0.2em] mb-2">Keterangan Transformasi</p>
                        ...
                        <div class="flex items-center justify-between p-4 bg-blue-950 rounded-xl text-white shadow-lg relative overflow-hidden">
                            ...
                            <div class="flex items-center gap-3 relative z-10">
                                ...
                                <span class="text-[9px] font-bold uppercase tracking-widest text-blue-300">Verifikasi</span>
                            </div>
                            <span class="text-[10px] font-mono font-bold relative z-10"><?= date('d/m/y H:i', strtotime($item['created_at'])) ?></span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <?php endforeach; else: ?>
            <div class="bg-white dark:bg-slate-900 p-20 rounded-2xl text-center border border-dashed border-slate-200 dark:border-slate-800 transition-all duration-300">
                ...
                <h3 class="text-xl font-bold text-slate-400 uppercase tracking-tighter">Belum Ada Histori</h3>
