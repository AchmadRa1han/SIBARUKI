...
<div class="space-y-6 pb-12 text-slate-900 dark:text-slate-200">
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-6 bg-blue-950 p-7 rounded-[2.5rem] text-white shadow-2xl shadow-blue-950/20 relative overflow-hidden transition-all duration-500">
        ...
        <div class="relative z-10 flex items-center gap-5">
            ...
            <div>
                <h1 class="text-2xl md:text-3xl font-black uppercase tracking-tighter leading-none">Aset Tanah</h1>
...
<script>
    ...
    function initMap() {
        ...
        try {
            ...
            map = L.map('map', { zoomControl: false, layers: [googleSat] }).setView([-5.1245, 120.2536], 12);
            ...
            const LayerToggle = L.Control.extend({
                onAdd: function(map) {
                    ...
                    L.DomEvent.on(btn, 'click', function(e) {
                        ...
                        setTimeout(() => {
                            if (map.hasLayer(googleSat)) { map.removeLayer(googleSat); map.addLayer(cartoDB); btn.style.backgroundColor = isDark ? '#0f172a' : '#ffffff'; btn.querySelector('svg').setAttribute('stroke', standardSvgColor); }
