...
<div class="max-w-7xl mx-auto space-y-6 pb-12 text-slate-900 dark:text-slate-200">
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-6 bg-white dark:bg-slate-900 p-8 rounded-2xl border border-slate-100 dark:border-slate-800 shadow-sm transition-all duration-300 relative overflow-hidden">
        ...
        <div class="flex items-center gap-2 relative z-10">
            ...
            <a href="<?= base_url('aset-tanah/edit/' . $aset['id']) ?>" class="px-5 py-2.5 bg-amber-500 hover:bg-amber-600 text-white rounded-xl text-[10px] font-bold uppercase tracking-widest shadow-lg shadow-amber-500/20 transition-all active:scale-95 flex items-center gap-2">
                <i data-lucide="edit-3" class="w-4 h-4"></i> Edit
            </a>
            <?php endif; ?>
            <a href="<?= base_url('aset-tanah') ?>" class="px-5 py-2.5 bg-slate-100 dark:bg-slate-800 text-slate-500 dark:text-slate-400 rounded-xl text-[10px] font-bold uppercase tracking-widest hover:bg-slate-200 dark:hover:bg-slate-700 transition-all active:scale-95">Kembali</a>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="space-y-6">
            <!-- Luas & Nilai -->
            <div class="bg-blue-950 p-8 rounded-2xl text-white shadow-xl relative overflow-hidden group">
                <div class="absolute -right-4 -bottom-4 opacity-10 group-hover:scale-110 transition-transform duration-700">
                    <i data-lucide="maximize" class="w-40 h-40"></i>
                </div>
                <div class="relative z-10 space-y-8">
                    <div>
                        <p class="text-[9px] font-bold uppercase tracking-[0.3em] text-blue-300 mb-2">Luas Bidang Tanah</p>
                        <p class="text-4xl font-bold italic"><?= number_format($aset['luas_m2'], 0, ',', '.') ?><span class="text-lg ml-1 opacity-40">M²</span></p>
                    </div>
                    <div class="pt-6 border-t border-white/10">
                        <p class="text-[9px] font-bold uppercase tracking-[0.3em] text-blue-300 mb-2">Estimasi Nilai Aset</p>
                        <p class="text-xl font-bold text-emerald-400 italic">Rp <?= number_format($aset['nilai_aset'], 0, ',', '.') ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white dark:bg-slate-900 rounded-2xl p-8 shadow-sm border border-slate-100 dark:border-slate-800 transition-all duration-300">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        <p class="text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-1.5">Status Kepemilikan</p>
                        <span class="px-3 py-1 bg-blue-50 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 rounded-full text-[9px] font-bold uppercase border border-blue-100 dark:border-blue-800"><?= $aset['status_tanah'] ?: 'AKTIF' ?></span>
                    </div>
                    <div>
                        <p class="text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-1.5">Tanggal Terbit</p>
                        <p class="text-sm font-bold text-slate-700 dark:text-white uppercase"><?= $aset['tgl_terbit'] ? date('d F Y', strtotime($aset['tgl_terbit'])) : '-' ?></p>
                    </div>
                    <div>
                        <p class="text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-1.5">Peruntukan Aset</p>
        ...
        <div class="lg:col-span-2 space-y-6">
            <div class="bg-white dark:bg-slate-900 rounded-2xl overflow-hidden shadow-sm border border-slate-100 dark:border-slate-800 relative group lg:h-[600px]">
                ...
                <div class="absolute top-6 left-6 z-[1000] flex items-center gap-3">
                    <div class="bg-blue-950/90 backdrop-blur-xl text-white px-4 py-2 rounded-xl shadow-2xl border border-white/10 flex items-center gap-3">
                        ...
                        <span class="text-[9px] font-bold uppercase tracking-[0.2em]">Visualisasi Titik Lokasi</span>
                    </div>
                </div>
                ...
                <div class="absolute inset-0 z-[1001] bg-slate-900/20 backdrop-blur-md flex items-center justify-center text-center p-10">
                    <div class="bg-white dark:bg-slate-900 p-8 rounded-2xl shadow-2xl border border-slate-100 dark:border-slate-800 max-w-sm">
                        ...
                        <h4 class="text-xs font-bold text-slate-400 uppercase tracking-widest mb-1">Koordinat Kosong</h4>
            ...
            <div class="bg-white dark:bg-slate-900 rounded-2xl p-8 shadow-sm border border-slate-100 dark:border-slate-800 transition-all duration-300">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
                    <div class="space-y-6">
                        <div>
                            <p class="text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-1.5">Wilayah Kecamatan</p>
                            <p class="text-sm font-bold text-blue-600 uppercase tracking-wider">Kec. <?= $aset['kecamatan'] ?></p>
                        </div>
                        <div>
                            <p class="text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-1.5">Desa / Kelurahan</p>
                            <p class="text-sm font-bold text-slate-700 dark:text-white uppercase tracking-wider"><?= $aset['desa_kelurahan'] ?></p>
                        </div>
                    </div>
                    <div class="space-y-6">
                        <div>
                            <p class="text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-1.5">Lokasi / Alamat</p>
                        ...
                        <div class="pt-4 border-t dark:border-slate-800">
                            <p class="text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-1.5">Catatan Inventaris</p>
